...
namespace DevExpress.Internal {
    ...
    public const int VersionId = 231;
    public const int VersionIdMinor = 23101;
    public const string VersionShort = "23.1";
    public const string Version = VersionShort + ".0.0";

    public const string FileVersion = Version;
    public const string MarketingVersion = "v2023 vol 1";
    public const string VirtDirSuffix = "_v23_1";
