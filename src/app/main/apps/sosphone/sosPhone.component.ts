...
@Component({
    selector: 'app-sosPhone',
    templateUrl: './sosPhone.component.html',
    styleUrls: ['./sosPhone.component.scss'],
    animations: fuseAnimations,
    encapsulation: ViewEncapsulation.None,

})
export class SOSPhoneComponent implements OnInit {
    ...
    constructor(
        ...
        this.duyrularervice.getGuzergah(2).then(result => {
            if (result['status'] == 'ok') {
