...
@Component({
    selector: 'app-birim-home',

    templateUrl: './birim-home.component.html',
    styleUrls: ['./birim-home.component.scss'],
...
export class BirimHomeComponent implements OnInit {
    displayedColumns: string[] = ['photo','aciklama', 'icerik' ];
    facID:any
    user_type: any
    depID:any
    constructor(
        public duyrularervice: MyDepartmentService,private _snackBar: MatSnackBar,
  ...
  goBackward() {
    ...
    async habergetir() {
      this.haberGeldi = false
        ...
        this.duyrularervice.get_haber_departman(this.depID).then(result => {
            this.dataget = result;
